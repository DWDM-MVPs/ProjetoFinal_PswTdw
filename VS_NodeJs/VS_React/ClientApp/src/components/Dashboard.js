												...
												<div className="Component">
																<div>
																				<form action="/action_page.php">
																								...
																								Name:<br />
																								<input type="text" name="name" onChange={(e) => this.updateEvent(e, "name")} />
																								<br />
																								<br />
																								Stock:<br />
																								<input type="number" name="stock" onChange={(e) => this.updateEvent(e, "stock")} />
																								<br />
																								<br />
																								Price:<br />
																								<input type="number" name="price" onChange={(e) => this.updateEvent(e, "price")} />
																								<br />
																								<br />
																								Allergens:<br />
																								<input type="radio" name="allergens" onChange={(e) => this.updateEvent(e, "allergens")} />
																								<br />
																								<br />
																								Is Active?:<br />
																								<input type="radio" name="isActive" onChange={(e) => this.updateEvent(e, "isActive")} />
																								<br /><br />
